...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .clip {
                clip-path: polygon(50% 0%, 100% 0, 100% 90%, 61% 100%, 35% 91%, 0 100%, 0 0);
            }
        </style>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">
            <div class="row bg-info justify-content-evenly pt-5 clip" style="padding-bottom: 70px;">
                <div class="col-md-8">
                    <div class="card" style="width: 18rem; margin: auto; border: 1px solid white;">
                        <div style="text-align: center;" class="bg-info">
                            <i class="bi bi-person-workspace" style="font-size: 35px;"></i><br>
                            <p style="font-size: 35px;">Login here</p>
                        </div>
                        <div class="card-body">
                            <form id="reg-form" action="LoginServlet" method="post">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Email address</label>
                                    <input type="email" name="user_mail" class="form-control" id="exampleInputEmail1"
                ...
                $('#reg-form').on('submit', function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            }else if (data.trim() === 'Invalid Details')
                            {
                                swal({
                                    title: "Oops",
