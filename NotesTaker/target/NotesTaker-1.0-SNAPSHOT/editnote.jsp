<%-- 
    Document   : editnote
    Created on : Oct 7, 2022, 10:32:02 AM
    Author     : User
--%>
...
<%
//Getting nid from url
    int nid = Integer.parseInt(request.getParameter("nId"));
    Note note = new Note();
    Note curNote = note.getNoteByNid(nid);
%>
        ...
        <div class="container-fluid">
            <div class="row justify-content-evenly">
                <div class="col-md-8 mt-5">
                    ...
                    <form id="add-form" action="UpdateNoteServlet" method="post" >
                        <div class="mb-3">
                            <input name="nid" type="hidden" value="<%= curNote.getnId()%>" class="form-control">
                            <label for="exampleFormControlInput1" class="form-label text-white">Note Title</label>
                            <input name="title" type="text" value="<%= curNote.getnTitle()%>" class="form-control" id="exampleFormControlInput1" placeholder="Note Tittle" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label text-white">Note Content</label>
                            <textarea name="content" class="form-control" id="exampleFormControlTextarea1" placeholder="Note Content" rows="8"><%= curNote.getnContent()%></textarea>
                        </div>
